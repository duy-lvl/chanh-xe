...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function stFrom($magellanExpression)
        {
                        return \Illuminate\Database\Query\Builder::stFrom($magellanExpression);
        }
                    /**
         * 
         *
...
namespace  { 
            ...
            public static function stFrom($magellanExpression)
            {
                                return \Illuminate\Database\Eloquent\Builder::stFrom($magellanExpression);
            }

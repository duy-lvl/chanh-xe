...
final class OrderFinalCheckpointReached extends Mailable implements ShouldQueue
{
    ...
    public function __construct(
        private Order $order,
        private OrderStatus $reachedCheckpoint,
    ...
    {
        return new Envelope(
            subject: 'Order Checkpoint Reached',
        );
    }
    ...
    {
        $statusVerb = OrderStatus::getVerb($this->reachedCheckpoint);
        ...
        return new Content(
            markdown: 'emails.orders.finalcheckpoint.reached',
            with: [
                ...
                'orderStatus' => $this->reachedCheckpoint,
                ...
                'receiveToken' => Str::upper($this->receiveToken),
                'receiveTokenQr' => \SimpleSoftwareIO\QrCode\Facades\QrCode::format('png')->generate($this->receiveToken)->toHtml(),
            ],
        );
    }
